...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://635f-103-255-156-10.ngrok-free.app/company/logincompany', { email, password })
      .then(result => {
        console.log(result);
        const { data } = result;
        if (data.token) {
          ...
          login(data.token);
          navigate('/dashboard'); // Navigasi ke dashboard setelah berhasil login
        ...
        <div className="flex justify-end items-center h-screen overflow-hidden text-white px-20">
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Link to="/newpass" className="text-end">
